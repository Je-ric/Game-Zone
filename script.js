    ...
    function addToHistory(playerChoice, computerChoice, result) {
        ...
        historyItem.className = 'p-2 border-b border-gray-200 flex justify-between items-center';
        ...
        historyItem.innerHTML = `
            ...
            <span class="font-medium ${resultClass}">${resultText}</span>
        `;
    ...
    resetBtn.addEventListener('click', function() {
        ...
        playerChoiceDisplay.innerHTML = '<i class="fas fa-question text-gray-400"></i>';
        computerChoiceDisplay.innerHTML = '<i class="fas fa-question text-gray-400"></i>';
